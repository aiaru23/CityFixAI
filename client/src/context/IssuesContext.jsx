...
export const IssuesProvider = ({ children }) => {
  ...
  return (
    <IssuesContext.Provider value={{ issues, loading, refetch: fetchIssues }}>
      {children}
